...
<div class="grid_16 background_blanc">
	<div class="fondtext">
		...
		<div class="text">
			N'hesitez pas à remplir le formulaire !
		</div>
		...
		<form class="form" enctype="multipart/form-data" method="post" action="<?php echo $_SERVER['REQUEST_URI']; ?>" id="ArticleEdit">
			...
			<div class="row">
				<label>Prenom</label>
				<div class="rowright">
					<input type="text" name="prenom" id="InputName" <?php echo isset($article['prenom']) ? 'value="'.$article['prenom'].'"' : ''; ?>>
			...
			<div class="row formrow">
				...
				<div class="rowright">
					<input type="text" name="adresse_mail" id="InputAdresse_mail" <?php echo isset($article['adresse_mail']) ? 'value="'.$article['adresse_mail'].'"' : ''; ?>>
			...
			<div class="row">
				...
				<div class="rowright">
					<input type="text" name="telephone" id="InputTelephone" <?php echo isset($article['telephone']) ? 'value="'.$article['telephone'].'"' : ''; ?>>

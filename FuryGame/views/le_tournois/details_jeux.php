...
<div class="grid_16">
	<div class="">
		...
		<img class="tfg_points_flag" src="<?php echo BASE_URL."/".$article['nb_points'];?>" title="<?php echo $article['title_image']; ?>" alt="<?php echo $article['alt']; ?>"/>
		...
		<img class="tfg_points_content" src="<?php echo BASE_URL;?>/img/jeux_tournois/tfg_points_content.jpg" title="joueurs" alt="joueurs"/>
